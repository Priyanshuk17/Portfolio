...
const StatsSection = () => {
  ...
  // CODE360 STATES
  // =====================================
  const [c360Solved, setC360Solved] = useState(77);
  const [c360Streak, setC360Streak] = useState(5);
  const [c360Level, setC360Level] = useState("Newbie");
  const [c360Contests, setC360Contests] = useState(2);
  const [c360Profile] = useState("https://www.naukri.com/code360/profile/Priyanshukeshri");
  ...
  const code360Handle = "Priyanshukeshri";
  const githubHandle = "Priyanshuk17";
  ...
  return (
    <div id="stats" className="stats-dashboard-container" ref={containerRef}>
      ...
      >
        ...
        {/* ==================== CODE360 MODULE ==================== */}
        <div
          className={`glass-module ${activeCard === "c360" ? "expanded" : activeCard ? "collapsed" : ""}`}
          onMouseEnter={() => setActiveCard("c360")}
          onClick={() => setActiveCard(activeCard === "c360" ? null : "c360")}
        >
          <div className="view-compact">
            ...
            <div className="compact-text-group">
              <div className="platform-title">CODE360.SYS</div>
              <div className="rank-tag">
                {c360Level.toUpperCase()}
              </div>
            </div>

            <div className="hero-section">
              <h2 className="hero-rating cf-color">{c360Solved}+</h2>
              <p className="hero-sub">PROBLEMS SOLVED</p>
            </div>

            <div className="stats-mini-grid">
              <div className="mini-box">
                <span>STREAK</span>
                <strong>{c360Streak} Days</strong>
              </div>

              <div className="mini-box">
                <span>LEVEL</span>
                <strong>{c360Level}</strong>
              </div>
            </div>
          ...
          <div className="view-expanded">
            <div className="exp-header">
              <h2>
                CODE360.SYS // <span className="cf-color">DSA_ANALYTICS</span>
              </h2>
            </div>
            ...
            <div className="exp-content">
              <div className="exp-stats-box">
                <p>
                  Problems Solved:{"77"}
                  <strong className="cf-color">{c360Solved}+</strong>
                </p>

                <p>
                  Coding Level:{"Newbie"}
                  <strong className="cf-color">{c360Level}</strong>
                </p>

                <div className="mt-8">
                  <p className="log-line">
                    {">"} DSA FOCUS: ARRAYS | TREES | GRAPHS
                  </p>
              ...
              <div className="terminal-log flex flex-col justify-center">
                ...
                <div className="space-y-4">
                  ...
                  <p className="log-line">
                    {">"} PLATFORM:
                    <span className="text-white"> CODE360</span>
                  </p>
        ...
        >
          ...
          <div className="view-compact">
            ...
            <a
              href="https://github.com/PriyanshuK17"
              target="_blank"
              rel="noreferrer"

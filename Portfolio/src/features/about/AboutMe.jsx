...
const timelineEvents = [
  {
    ...
    title: "B.Tech at TMSL Kolkata",
    desc: "Computer Science undergraduate at TMSL Kolkata with a consistent 8+ CGPA. Focused on mastering core CS fundamentals, systems thinking, and scalable problem-solving.",
    color: "from-blue-500/20 to-indigo-500/20",
    border: "border-indigo-500/30",
    tags: ["CS Fundamentals", "CGPA: 8+", "Systems Thinking"],
  ...
  },
  {
    ...
    desc: "Solved 200+ DSA problems across platforms. LeetCode rating: 1446.777. Codeforces rating: 733. I compete to win, not participate.",
  ...
  },
  {
    ...
    desc: "Engineered production-ready backend systems including  (full-stack web app) and a high-performance URL Shortener with analytics and optimized server-side architecture.",
  ...
  },
  {
    ...
    desc: "Collaborating on development projects, practicing DSA consistently, and actively learning modern full-stack and AI technologies through developer communities.",
  ...
  },
  {
    ...
    desc: "Completed XII CBSE from Rajkamal Saraswati Vidya Mandir, Dhanbad with 73.2%. Built academic discipline and competitive consistency early on.",
    color: "from-orange-500/20 to-red-500/20",
    border: "border-orange-500/30",
    tags: ["73.2%", "Physics", "Chemistry", "Maths"],
  ...
  },
  {
    ...
    date: "2020",
    title: "Class X (CBSE))",
    desc: "Completed X CBSE from Rajkamal Saraswati Vidya Mandir, Dhanbad with 82.2%. Strong academic foundation across mathematics and sciences.",
    color: "from-orange-500/20 to-red-500/20",
    border: "border-orange-500/30",
    tags: ["82.2%", "Foundation", "Academics"],
    status: "ARCHIVED_DATA"
  },
  {
    id: 7,
    ...
    desc: "Passionate about cricket and multi-sport athletics, particularly volleyball and badminton. Sports have helped me develop leadership, teamwork, discipline, and decision-making skills under pressure.",
    color: "from-yellow-500/20 to-amber-500/20",
    border: "border-yellow-500/30",
    tags: ["Cricket", "Volley Ball", "Athelete"],

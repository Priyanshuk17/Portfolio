          ...
          >
            ...
            <motion.div variants={itemVariants} className="bg-[#121214]/60 backdrop-blur-xl rounded-2xl border border-white/10 p-6 shadow-xl relative overflow-hidden group">
              ...
              <div className="font-mono text-sm leading-loose">
                ...
                <p className="pl-4"><span className="text-blue-400">string</span> email = <span className="text-green-400">"keshripriyanshu732@gmail.com"</span>;</p>
                <p className="pl-4"><span className="text-blue-400">string</span> phone = <span className="text-green-400">"+91-8541840372"</span>;</p>
                <p className="pl-4"><span className="text-blue-400">string</span> location = <span className="text-green-400">"TMSL Kolkata"</span>;</p>
                <p>{'};'}</p>
              </div>
            </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-zinc-500 text-xs font-mono mt-1 break-all">keshripriyanshu732@gmail.com</p>
                </div>
              </motion.a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-zinc-500 text-xs font-mono mt-1">/PriyanshuK17</p>
                </div>
              </motion.a>

              <motion.a 
                variants={itemVariants}
                href="https://www.linkedin.com/in/priyanshu-keshri-26b576291"
                target="_blank"
                rel="noreferrer"
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-zinc-500 text-xs font-mono mt-1">/in/priyanshu-keshri</p>
                </div>
              </motion.a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-zinc-500 text-xs font-mono mt-1">+91-8541840372</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
